...
<div class="nav">
	...
	<div id="bg-filtro">
							...
							<div id="filtro-topo">
							<form method="get" class="advanced-searchform" action="<?=($quemsomos['vimeo']);?>/site/">
		...
		<div class="width-container">
          ...
          <div id="lado-a-lado2">
			<form method="get" class="searchform" action="<?=($quemsomos['vimeo']);?>/site/">
				...
				<input type="text" class="field" name="codigo" id="c" placeholder="Busca por Código do Imóvel" />
				<input type="submit" class="submit" id="searchsubmit" value="Buscar" />
