...
*/
									echo "<option value='1' selected='selected'>Venda</option> ";

									echo "<option value='2' >Aluguel</option> ";	
...
*/
									...
									echo "<option value='19' >Arroio do Sal</option> ";
									echo "<option value='16' >Barra do Ribeiro</option> ";
									echo "<option value='15' >Eldorado do Sul</option> ";
									echo "<option value='20' >Esteio</option> ";
									echo "<option value='14' >Guaíba</option> ";
									echo "<option value='21' >Mariana Pimentel</option> ";
									echo "<option value='18' >Porto Alegre</option> ";
									echo "<option value='22' >Sertão Santana</option> ";
...
$('#recebendo').multiselect('select', vetor[i]); //seta os bairros selecionados
                    ...
                    var vetor = ['Alegria','Altos da Alegria','Alvorada','Bela Vista','Bom Fim Novo','Bom Fim Velho','Centro','Chácara das Paineiras','Cohab','Colina','Columbia City','Coronel Nassuca','Engenho','Ermo','Fátima','Florida','Jardim dos Lagos','Jardim Panorama','Laranjeiras','Neiva','Nova Guaíba','Parque 35','Parque Noli','Passo Fundo','Pedras Brancas','Primavera','Ramada','Rural','Santa Rita','São Francisco','São Geraldo','São Jorge','Spagiari','Vera Cruz','Vila Elza','Vila Iolanda','Vila Jardim','Vila Nova'];
...
$('#recebendo').multiselect('select', vetor[i]); //seta os bairros selecionados
                    ...
                    var vetor = ['Area Rural','Bom Retiro','Centro','Chácara','Cidade Verde','Itai','Parque Eldorado','Picada','Sans Souci'];
...
else if(id==20){ //Bairros esteio

        

var vetor = ['Bairro Do Parque',
...
else if(id==21){ //Bairros mariana pimentel
