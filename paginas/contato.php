<?
if ($_GET['unidade']>0) {
	$busca = " AND id_destaque=".(int)$_GET['unidade'];
}  
?>
<div id="main">
	<div class="width-container">
		...
		<div id="container-sidebar">
			<div class="content-boxed">
				<h2 class="title-bg">Onde você está? 	<?
					$i=0;
					$SQL = "SELECT * FROM  tbdestaque ORDER BY id_destaque ASC";
					$Lista = new Consulta($SQL,99,$PGATUAL);
					while ($linha = db_lista($Lista->consulta)) { $i++; ?>


					<a href="<?=($quemsomos['vimeo']);?>/site/?p=contato&unidade=<?=($linha['id_destaque']);?>" class="button secondary-button"><?=($linha['cidade']);?></a>
