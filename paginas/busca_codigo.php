	...
	<div class="width-container">
		...
		<div class="flexslider">
          <ul class="slides">
				...
				$SQL = "SELECT 
							...
							WHERE premium=1 AND flag_status=1
							ORDER BY 
				...
				?>
					...
					<li>
		  	    	    <a href="<?=($quemsomos['vimeo']);?>/<?=$linha['id_galeria'];?>/<?=(nomeArquivo($linha['titulo']));?>"><img src="<?=($quemsomos['vimeo']);?>/arquivos/galeria/<?=($linha['codigo']);?>/capa.jpg" alt="<?=($linha['titulo']);?>">
							<div class="flex-caption">
								<div class="featured-address-number"><?=($linha['bairro']);?></div>
								<div class="featured-address-city"><?=($linha['categoria']);?> - <?=($linha['estado']);?></div>
								<div class="featured-price">R$ <?=($linha['preco']);?></div>
							</div>
						</a>
		  	    	</li>
		...
		<div id="container-sidebar">
			<div class="content-boxed">
				<h2 class="title-bg">Busca pelo Código: &quot;<?=utf8_encode(trim($codigo));?>&quot;</h2>
