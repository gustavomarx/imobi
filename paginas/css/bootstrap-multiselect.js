...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            nSelectedText: 'opções',
            numberDisplayed: 1
        },

        templates: {
            button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown" style="width: 136px; height: 30px; margin-top: -5px; font-size: 11px;"></button>',
            ul: '<ul class="multiselect-container dropdown-menu"></ul>',
            filter: '<div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text"></div>',
            li: '<li style="border-right: none; border-bottom: 1px solid #d5d5d5"><a href="javascript:void(0);" ><label></label></a></li>',
