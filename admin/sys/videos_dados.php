...
<?
	...
	$campos = array(
		...
		array('text',		'Título do Vídeo',		'titulo',			'500',			'',					'',											''),
		array('text',		'Código da URL',		'video',			'500',			'',					'<span style="color:red;"><br>Exemplo: </span>www.youtube.com/watch?v=<b><span style="color:#555;">B2lhR2aBpo0</span></b> - Cole apenas o código do final',											''),
		array('textarea',	'Descrição do vídeo',	'descricao',		array(80,10),	'',					'',											''),
	);
