...
jQuery(function($){
	$('a.zoom<?=$foto['id_foto'];?>').easyZoom();
		...
		<td width="80" align="center">
        	<label><input value="1" type="checkbox" id="foto<?=$foto['id_foto'];?>" name="foto[<?=$foto['id_foto'];?>]" style="border:0"><a href="../../arquivos/galeria/<?=$dados2['codigo'];?>/fotos/<?=$foto['imagem'];?>" class="zoom<?=$foto['id_foto'];?>"><img id="imagemver" alt="<?=(int)$foto['contador'];?> views" src="../../arquivos/galeria/<?=$dados2['codigo'];?>/miniaturas/<?=$foto['imagem'];?>" /></a></label><br />
