...
<table class="viewCampos" id="uploadForm">
  <form name="frm1" action="../app/alunos.php?faz=fotosForm" method="post" enctype="multipart/form-data">
  ...
  <? for ($i=1;$i<=8;$i++) { ?>
	...
	Vídeo: <input type="text" name="video[<?=$i;?>]">
	</td>
  <?
...
<table class="viewCampos" id="uploadFtp" style="display:none;">
  <form name="frm1" action="../app/alunos.php?faz=fotosFtp" method="post" enctype="multipart/form-data">
  <input maxlength="25" type="hidden" name="id_aluno" value="<?=$dados2['id_aluno'];?>" >
  <tr><td>Baixar as fotos de <font face="Courier New, Courier, monospace">/arquivos/alunos/ftp/</font></td></tr>
...
<table >
  <form name="frm1" action="../app/alunos.php?faz=photosAction" method="post" enctype="multipart/form-data">
  <input maxlength="25" type="hidden" name="id_aluno" value="<?=$dados2['id_aluno'];?>" >
  <tr>
  <?
  ...
  ?>
		<td width="80" align="center">
        	<label><input value="1" type="checkbox" id="foto<?=$foto['id_foto'];?>" name="foto[<?=$foto['id_foto'];?>]" style="border:0"><img alt="<?=(int)$foto['contador'];?> views" src="../../arquivos/alunos/<?=$dados2['codigo'];?>/miniaturas/<?=$foto['imagem'];?>" /></label><br />
