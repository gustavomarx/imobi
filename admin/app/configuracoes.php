<? 
	...
	if ($_GET['faz']=="dados") {
		...
		# Dados
		$dados = array( 'id_config'=>$id_config, 'nomesite'=>$nomesite, 'slogansite'=>$slogansite, 'emailsite'=>$emailsite, 'pagseguro'=>$pagseguro, 'token'=>$token, 'twitter'=>$twitter, 'facebook'=>$facebook, 'youtube'=>$youtube, 'endereco'=>$endereco);
