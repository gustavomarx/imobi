<? 
	...
	if ($_GET['faz']=="dados") {
		...
		# Testes
		$Erros='';
		if (strlen($cidade) < 2) $Erros .= "- Informe o nome da Cidade|";
		...
		# Dados
		$dados = array( 'id_destaque'=>$id_destaque, 'cidade'=>$cidade, 'endereco'=>$endereco, 'cep'=>$cep, 'imagem'=>$imagem, 'telefone'=>$telefone);
